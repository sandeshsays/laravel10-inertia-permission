            ...
            <div>
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    <li>
                        <SidebarLink
                        href="/dashboard"
                        :active="false" aria-label="dashboard" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                    ...
                    <li>
                        ...
                        :active="route().current('users.index')" aria-label="users" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                    ...
                    <li>
                        ...
                        :active="route().current('roles.index')" aria-label="roles" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
                    ...
                    <li>
                        ...
                        :active="route().current('permissions.index')" aria-label="permissions" class="relative px-4 py-3 flex items-center space-x-4 rounded-xl text-white bg-gradient-to-r from-sky-600 to-cyan-400">
