    ...
    <div class="w-full h-full">
        <aside class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen border-r bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]">
            <div>
                ...
                <ul class="space-y-2 tracking-wide mt-8">
                    <li>
                        <SidebarLink
                        href="/dashboard"
                        :active="false" aria-label="dashboard">
                    ...
                    <li>
                        ...
                        :active="route().current('users.index')" aria-label="users">
                    ...
                    <li>
                        ...
                        :active="route().current('roles.index')" aria-label="roles">
            ...
            <div class="px-6 -mx-6 pt-4 flex justify-between items-center border-t">
                ...
                class="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group hover:text-red-600">
